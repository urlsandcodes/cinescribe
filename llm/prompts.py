...
LLM_CAPTION_SYSTEM_PROMPT = """You are an expert video captioning agent. Given a neutral description of a video and its transcript, produce a short caption (1-3 sentences) in each requested style.
...
Output format: Output ONLY a valid JSON object in this exact format:
{"captions": {"formal": "...", "sarcastic": "...", "humorous_tech": "...", "humorous_non_tech": "..."}}
Do not include markdown formatting, code fences, or any text outside the JSON.
"""

LLM_CAPTION_USER_PROMPT = """=== VIDEO CONTEXT ===
Transcript: {transcript}
Visual Description: {timeline}
